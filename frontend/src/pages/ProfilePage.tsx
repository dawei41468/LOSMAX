...
const ProfilePage: React.FC = () => {
  ...
  return (
    <AppShell
      ...
      subtitle={t('content.profile.subtitle')}
      showBottomNav={true}
      headerRight={(
        <div className="flex items-center gap-2">
          <span className="inline-flex h-6 w-6 items-center justify-center rounded-sm box-border overflow-hidden">
            <ThemeSwitcher />
          </span>
          <span className="inline-flex h-6 w-6 items-center justify-center rounded-sm box-border overflow-hidden">
            <LanguageSwitch />
    ...
    >
      ...
      {/* Spacer equal to fixed app header height + 9rem (UserCard height + gap to tabs) */}
      <div className="pt-[calc(var(--app-header-h)+9rem)]">

        {/* Full-bleed container for tabs and content - scrolls over UserCard */}
        <div 
          className=" z-40 bg-background"
          style={{ marginLeft: 'calc(-1 * var(--app-content-px))', marginRight: 'calc(-1 * var(--app-content-px))' }}
        >

          {/* Tabs Section (sticky, higher z-index to stay above content) */}
          <div
            id="tabs-section"
            className="sticky top-[var(--app-header-h)] z-50 bg-surface"
          >
            <div className="flex">
              <button
          ...
          {/* Tabs Content Area - scrolls beneath sticky tabs */}
                          ...
                          <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                              <input
                                ...
                                className="w-full sm:flex-1 border border-[var(--border)] rounded-[var(--radius)] px-3 py-3 sm:py-2 bg-card text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                              />
                              <Button
